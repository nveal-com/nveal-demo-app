            ...
            <div>
                ...
                <div class="relative">
                    <input
                        type="text"
                        id="credit_card"
                        bind:value={credit_card}
                        placeholder="0000 0000 0000 0000"
                        class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 {cardError
                            ? 'border-red-500 focus:ring-red-500'
                            : ''}"
                    />
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-6 w-6 absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
